...
---
= Prepare a KVM host for ONTAP Select
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
+
Install the RHEL operating system using the ISO image. Refer to the link:reference_plan_ots_hardware.html#software-compatibility[software compatibility information for hypervisors] for a list of the supported RHEL versions. During installation, configure the system as follows:
+
...
+
For additional information about the necessary packages and other configuration requirements, refer to  the link:https://imt.netapp.com/matrix/#welcome[Interoperability Matrix Tool^].
...
+
Refer to the link:https://docs.redhat.com/en/documentation/red_hat_enterprise_linux/5/html/virtualization/chap-virtualization-pci_passthrough#sect-Virtualization-PCI_passthrough-AI_device_to_a_host[Red Hat Documentation^] for instructions on how to configure PCI passthrough (DirectPath IO) for a KVM hypervisor.
