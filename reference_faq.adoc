...
If a capacity pool subscription lapses, the system will warn you first but after 30 days, if the system shuts down, it won't reboot until an updated subscription is installed on the Deploy server. 
