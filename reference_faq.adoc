...
[NOTE]
Beginning with ONTAP Select 9.10.1 the KVM hypervisor is no longer supported when creating a new cluster. Questions involving KVM are applicable only to earlier releases that support KVM.
