...
[NOTE]
Beginning with ONTAP Select 9.10.1 the KVM hypervisor is no longer supported. Questions involving KVM are only applicable to earlier releases that support KVM.
