...
MetroCluster SDS provides a synchronous replication solution and falls under NetApp MetroCluster solutions. However, the key difference is the connectivity type (only IP networks are supported rather than FC and IP).
