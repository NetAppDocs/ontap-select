...
---
= Learn about software RAID configuration services for ONTAP Select local attached storage
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
*RDD disk partitioning for multi-node clusters (HA pairs)*

image:ST_20.jpg[RDD disk partitioning for multi-node clusters (HA pairs)]
...
image:ST_21.jpg[Matching an ONTAP Select Disk to the Corresponding ESXi Disk]
