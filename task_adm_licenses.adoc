...
. Optionally, select *Filter* to limit the licenses displayed.
...
For more information about ONTAP Select and license renewal, refer to the Licenses, installation, upgrades, and reverts section in the link:reference_faq.html#licenses-installation-upgrades-and-reverts[FAQ].
