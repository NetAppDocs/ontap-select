...
Beginning with ONTAP Select 9.19.1, ONTAP Select supports AMD processors for KVM and ESXi hypervisor hosts. For more information, refer to link:reference_plan_ots_hardware.html[VMware hypervisor and hardware considerations].
