...
+
From 6 to 8 nodes, 6 to 10 nodes, 6 to 12 nodes, 8 to 10 nodes, 8 to 12 nodes, and 10 to 12 nodes.
+
* You can contract clusters as follows: 
+
From 12 to 10 nodes, 12 to 8 nodes, 12 to 6 nodes, 10 to 8 nodes, 10 to 6 nodes, and 8 to 6 nodes.
