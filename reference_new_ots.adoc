...
Beginning with ONTAP Select 9.16.1, Autonomous Ransomware Protection (ARP) (manual updates) is supported. The ARP feature license is included in the NetApp License File (NLF) for ONTAP Select 9.16.1. link:reference_lic_ontap_features.html#ontap-features-automatically-enabled-by-default[Learn more].
+
