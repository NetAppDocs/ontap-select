...
Beginning with ONTAP Select 9.18.1, there are no software RAID workflow limitations for KVM hypervisor on Red Hat Enterprise Linux (RHEL) 10.1 and 10.0 and Rocky Linux 10.0. The software RAID limitations only affect KVM hosts deployed with ONTAP Select 9.17.1.
