...
|===
+
The product download changes also apply to ONTAP Select 9.17.1, 9.16.1, 9.15.1, and 9.14.1.
...
Beginning with ONTAP Select 9.18.1, there are no software RAID workflow limitations for the KVM hypervisor on Red Hat Enterprise Linux (RHEL) 10.1 and 10.0 and Rocky Linux 10.0. The software RAID workflow limitations only affect RHEL 10.1 and 10.0 and Rocky Linux 10.0 deployed with ONTAP Select 9.17.1.
...
Beginning with ONTAP Select 9.17.1, KVM hypervisor is supported on Red Hat Enterprise Linux (RHEL) 10.1, 10.0, 9.7, and 9.6 and Rocky Linux 10.0 and 9.6.
+
[NOTE]
====
