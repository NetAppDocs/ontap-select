...
NetApp have updated the ONTAP Select product download options on the NetApp Support site with the ONTAP Select 9.18.1 release. Previously, there were four options, ONTAP Select, ONTAP Select Deploy Upgrade, ONTAP Select Image Install, and ONTAP Select Node Upgrade. With the ONTAP Select 9.18.1 release, these four options are replaced by two new options, *ONTAP Select Deploy* and *ONTAP Select image*. The changes to the product download options also apply to ONTAP Select 9.17.1, 9.16.1, 9.15.1, and 9.14.1.
+
For information on downloading the *ONTAP Select Deploy* and *ONTAP Select image* options, see the following procedures:
+
