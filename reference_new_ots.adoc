...
A new license is needed for NVMe/TCP if you're upgrading to ONTAP Select 9.13.1 from a previous version. The license is automatically included if you're deploying the feature for the first time from 9.13.1.

Updated VMware ESXi support::

VMware ESXi 8.0 GA (build 20513097) is supported with ONTAP Select 9.13.1, with hardware version support from 4 to 20.
