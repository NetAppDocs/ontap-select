...
Beginning with ONTAP Select 9.18.1, the software RAID workflow limitations that applied in ONTAP Select 9.17.1 for the KVM hypervisor on Red Hat Enterprise Linux (RHEL) 10.1 and 10.0 and Rocky Linux 10.1 and 10.0 have been removed.
