...
Beginning with ONTAP Select 9.17.1, the following licensed ONTAP features are supported with ONTAP Select. These features are enabled by default when you deploy an ONTAP Select 9.17.1 cluster or upgrade an existing ONTAP Select cluster to version 9.17.1:
* SnapLock Select
+
* Snapmirror Cloud
