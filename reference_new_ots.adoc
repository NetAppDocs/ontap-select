...
|===
// +
// NOTE: The product download changes also apply to ONTAP Select 9.17.1, 9.16.1, 9.15.1, and 9.14.1.
...
[NOTE]
====
There are software RAID workflow limitations for KVM hypervisors on RHEL 10.1 and 10.0 and Rocky Linux 10.1 and 10.0 hosts. For more information, refer to the following Knowledge Base articles:
