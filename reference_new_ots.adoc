...
The ONTAP Select product download options on the NetApp Support site are changing with the ONTAP Select 9.18.1 release, as shown in the following table:
+
