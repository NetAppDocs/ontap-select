...
ONTAP Select 9.17.1 includes enhanced support for cluster expansion and contraction on ESXi hypervisor hosts. You can increase the size of an existing ONTAP Select cluster from six-nodes up to a maximum of twelve-nodes. You can reduce the size of an existing ONTAP Select cluster from twelve-nodes down to a minimum of six-nodes. This enhancement provides greater flexibility for scaling ONTAP Select clusters on ESXi hosts. KVM support remains unchanged.
+
* You can perform the following cluster expansions:
+
** From six nodes to eight, ten, or twelve nodes
** From eight nodes to ten or twelve nodes
** From ten nodes to twelve nodes
+
* You can perform the following cluster contractions: 
+
** From twelve nodes to ten, eight, or six nodes
** From ten nodes to eight or six nodes
** From eight nodes to six nodes
