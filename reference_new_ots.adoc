...
+
You can increase the cluster size from a six-node cluster to an eight-node cluster with the cluster expansion feature. Operate the cluster expansion feature from the API, CLI, or web interface; from a six-node cluster size up to the maximum eight-node cluster size.

* Cluster contraction eight-node to six-node clusters
+
You can decrease the cluster size from an eight-node cluster to six-node cluster with the cluster contraction feature. Operate the cluster contraction feature from the API, CLI, or web interface; from an eight-node cluster size to a six-node cluster size.
...
// 2023 Feb 01,mairead 9.12.1 GA documentation update
// 2023 Feb 10, clean-up
// 2023 Apr 05, ONTAPDOC-920
// 2023 Apr 12, ONTAPDOC-979
// 2023 Sep 25, ONTAPDOC-1204, ONTAPDOC-1293
