...
ONTAP Select 9.18.1 includes several new features and improvements.

Enhanced support for cluster expansion and contraction::
Beginning with ONTAP Select 9.18.1, cluster expansion and contraction is supported between four-node and twelve-node clusters on ESXi and KVM hosts:
+
--
You can increase the cluster size for an existing ESXi or KVM cluster in the following increments:
...
You can decrease the cluster size for an existing ESXi or KVM cluster in the following increments:
