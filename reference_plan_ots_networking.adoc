...
---
= ONTAP Select networking requirements
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[NOTE]
To learn more about how to configure a vSwitch on a hypervisor host and the high speed interface feature, refer to the link:concept_nw_concepts_chars.html[Deep dive networking] section.
...
Refer to the link:concept_nw_concepts_chars.html[Deep dive networking] section for more information about two-NIC deployments.
...
Refer to the link:concept_nw_concepts_chars.html[Deep dive networking] section for more information about four-NIC deployments.
