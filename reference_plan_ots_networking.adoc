...
See the link:concept_stor_concepts_chars.html[Deep dive] section for more information about two-NIC deployments.
...
See the link:concept_stor_concepts_chars.html[Deep dive] section for more information about four-NIC deployments.
