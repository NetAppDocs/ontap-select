...
[NOTE]
To learn more about how to configure a vSwitch on a hypervisor host and high speed interface feature, see the link:concept_nw_concepts_chars.html[Deep dive networking] section.
