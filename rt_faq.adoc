...
A VMXNET3 driver is used instead of an E1000 driver. Note that upgrades from 9.4 to 9.5 still use the E1000 driver. There is a manual procedure to switch to the VMXNET3 driver after the upgrade. Contact technical support to perform the driver upgrade.
