...
+
Deploy displays this page when you first sign in. You can also open the drop down box at the top right of the page and select *Getting Started* to display this page. The LLID displays in the Add Licenses section.
* Select the *Administration* tab at the top of the page, then select *Systems & AutoSupport*.
...
// 2026 FEB 12, ontap-select-issue-314
