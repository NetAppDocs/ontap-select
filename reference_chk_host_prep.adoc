...
.Additional packages required for Red Hat Enterprise Linux 7.7
...
You should verify that the following packages and dependencies are installed when using RHEL 7.6 or CentOS 7.6. In each case, the package name and version are included.
...
You should verify that the following packages and dependencies are installed when using RHEL 7.5 or CentOS 7.5. In each case, the package name and version are included.
...
You should verify that the following packages and dependencies are installed when using RHEL 7.4 or CentOS 7.4. In each case the package name and version are included.
...
.Before you begin
Verify that you can sign in to the Linux command line interface on the host where ONTAP Select is deployed.
...
.Before you begin
Verify that you can sign in to the Linux command line interface where ONTAP Select is deployed.
