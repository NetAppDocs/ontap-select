...
* https://mysupport.netapp.com/site/downloads/evaluation/ontap-select[You have accepted the End User License agreement^] for an ONTAP Select deployment with an evaluation license.
