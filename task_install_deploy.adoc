...
.Before you begin
You have a registered NetApp Support Site account. For more information, see https://docs.netapp.com/us-en/bluexp-tiering/task-support-registration.html[Register for support^].
