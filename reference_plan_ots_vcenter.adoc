...
link:https://docs.netapp.com/us-en/ontap-select/reference_plan_dep_vmware.html#vmware-vcenter-server-considerations[Learn about VMware vSphere privileges for vSAN ESA in vCenter]
