...
[NOTE]
Beginning with ONTAP Select 9.10.1, you can no longer deploy a new cluster on the KVM hypervisor. You can still use KVM with an earlier supported release.
