...
[NOTE]
Beginning with ONTAP Select 9.10.1, you can no longer deploy a new cluster on the KVM hypervisor. The sample below is applicable to earlier releases that support KVM.
