...
[NOTE]
Beginning with ONTAP Select 9.10.1 the KVM hypervisor is no longer supported when creating new clusters. The sample below is applicable to earlier releases that support KVM.
