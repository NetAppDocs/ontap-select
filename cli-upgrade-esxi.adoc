---
sidebar: sidebar
permalink: cli-upgrade-esxi.html.html
...
---
= Upgrade to VMware ESXi 7.0 or later for ONTAP Select
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
+
Performing an ESXi upgrade using the Deploy administration utility is the more general and resilient option. However, there might be instances when Deploy is unavailable or cannot be used. For example, upgrading to ESXi 7.0 is not supported with earlier versions of ONTAP Select and the Deploy administration utility.
+
