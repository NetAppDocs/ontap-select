...
keywords: ontap select, best practices, recommendations
summary: consider best practices when planning your ontap select deployment
---
...
For performance reasons, the minimum number of disks is still eight, but the RAID group size should not be larger than 12 drives. The maximum number of drives per RAID group is 24.
