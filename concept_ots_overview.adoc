...
The FlexCache cache volume for write-back with ONTAP Select configuration has the following requirements:

* Use ONTAP Select medium (8-core) or large (16-core) instance. Small ONTAP Select instances (4-core) are not supported.
...
Learn more about the link:https://docs.netapp.com/us-en/ontap/flexcache-writeback/flexcache-write-back-guidelines.html[ONTAP FlexCache write-back guidelines^]
