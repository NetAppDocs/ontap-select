...
ONTAP Select supports FlexCache cache volume for write-back. The overall ONTAP Select instance performance is comparable to a low-end ONTAP system.

NOTE: ONTAP Select does not support FlexCache origin with write-back.
