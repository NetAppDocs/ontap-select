...
In a commodity world where data is fragmented across silos of direct-attached storage (DAS), SVM-Migrate and management have become more complex problems. Software-defined storage (SDS) has emerged as an important part of the SDI landscape to address these and other issues.
...
* Consistency group configurations in SnapMirror
* Fibre Channel
+
