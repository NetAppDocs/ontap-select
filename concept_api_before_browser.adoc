...
---
= Learn about accessing the ONTAP Select Deploy API with a browser
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
* Example Value
If you select _Example Value_ on an API call, a typical JSON structure for the call is displayed. You can modify the example as needed and use it as input for your request.

* Model
If you select _Model_, a complete list of the JSON parameters is displayed, with a description for each parameter.
