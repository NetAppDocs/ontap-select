...
. On the main page, scroll to the bottom and select *Cluster*.

. Select *GET /clusters/{cluster_id}* to display the details of the API call used to return information about an ONTAP Select cluster.
