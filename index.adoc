...
[NOTE]
Beginning with ONTAP Select 9.10.1 you can no longer deploy a new cluster on the KVM hypervisor. However, if you upgrade from a previous release to 9.10.1 you can still use the Select Deploy utility to administer the cluster.
