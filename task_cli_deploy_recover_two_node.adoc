...
== Step 1: Prepare to recover the Deploy utility

You need to prepare before attempting to recover an instance of the Deploy utility to assure success. You must be familiar with several administrative procedures and have the required information.
...
. Verify that you can sign in to the ONTAP CLI of the ONTAP Select cluster and use the shell interface.
...
If you use Capacity Pools licensing, reinstall each Capacity Pool license. See link:task_adm_licenses.html#reinstalling-a-capacity-pool-license[Reinstall a Capacity Pool license] for additional details.
