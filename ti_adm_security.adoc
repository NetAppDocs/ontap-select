...
. Click *Management Servers* and then click *Add*.

. Provide the account credentials and click *Add*.

. Optionally select the new management server and click image:icon_kebab.gif[Options] and select one of the following:
+
* Update credentials
* Register as plug-in
* Verify credentials
