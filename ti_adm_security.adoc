...
. You can optionally install the Deploy vCenter plug-in.

. After the new management server is addeded, you can optionally click image:icon_kebab.gif[Options] and select one of the following:
+
* Update credentials
* Register as plug-in
* Verify credentials
