...
You can access the https://library.netapp.com/ecm/ecm_download_file/ECMLP2876869[ONTAP Select 9.9.1 Release Notes] to view details of the current version.
