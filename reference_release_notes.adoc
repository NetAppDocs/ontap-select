...
You can access the link:https://library.netapp.com/ecm/ecm_download_file/ECMLP3365264[ONTAP Select 9.18.1 Release Notes^] to view the details about the current version.
