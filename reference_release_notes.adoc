...
You can access the link:https://library.netapp.com/ecm/ecm_download_file/ECMLPxxxxxxxx[ONTAP Select 9.19.1 Release Notes^] to view the details about the current version.
