...
You can access the https://library.netapp.com/ecm/ecm_download_file/ECMLP3330673[ONTAP Select 9.16.1 Release Notes^] to view the details about the current version.
