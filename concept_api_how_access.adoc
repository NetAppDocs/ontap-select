...
---
= Learn about accessing the ONTAP Select Deploy API
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
NOTE: The REST API included with ONTAP Select Deploy is assigned a version number. The API version number is independent of the Deploy release number. The ONTAP Select 9.19.1 Deploy administration utility includes version 3 of the REST API.
