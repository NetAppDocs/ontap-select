...
---
= ONTAP Select VMware hypervisor and hardware requirements
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[NOTE]
ESXi 7.0 GA reached end of availability status. If you have ONTAP Select clusters with this version, you must upgrade to the supported versions as per the https://mysupport.netapp.com/matrix[Interoperability Matrix Tool (IMT)^].
--
=====
...
ONTAP Select supports CPU models based on Intel Xeon Sandy Bridge and Advanced Micro Devices (AMD) processors.

Refer to the https://mysupport.netapp.com/matrix[Interoperability Matrix Tool^] for more information.
...
The supported microprocessors include Intel Xeon server processors and AMD processors.

Refer to link:https://www.intel.com/content/www/us/en/products/processors/xeon/view-all.html?Processor+Type=1003[Intel Xeon Processors^] and link:https://www.amd.com/en/products/processors/server/epyc.html[AMD EPYC Server CPUs^] for more information. 
...
NOTE: There are additional disk requirements based on the platform license. See link:reference_plan_ots_storage.html[Storage and RAID] for more information.

.Related information

Learn about link:concept_lic_platforms.html[the platform license offerings for ONTAP Select]

// 2025 APR 27, ONTAPDOC-3784
