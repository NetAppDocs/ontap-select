...
The supported microprocessors include Intel Xeon processors for Server and AMD processors.

For more information, refer to link:https://www.intel.com/content/www/us/en/products/processors/xeon/view-all.html?Processor+Type=1003[Intel Xeon Processors,window=_blank^] and link:https://www.amd.com/en/products/processors/server/epyc.html[AMD EPYC Server CPUs^].
