...
[NOTE]
There are additional disk requirements based on the platform license. See link:ri_plan_ots_storage.html[Storage and RAID considerations] for more information.
