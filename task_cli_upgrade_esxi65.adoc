...
[CAUTION]
If you choose to upgrade to VMware ESXi 7.0, you should upgrade to ESXi U2 (build 8294253) or greater. Using ESXi 7.0 U1 can expose you to a virtual machine failure due to a known VMware bug.
