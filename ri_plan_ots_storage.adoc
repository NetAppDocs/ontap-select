...
You need to manually configure the NVMe drives before using them. See link:ti_chk_nvme_configure.html[Configuring a host for NVMe drives] for more information.
