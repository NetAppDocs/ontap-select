...
After deploying the cluster, confirm the ONTAP Select AutoSupport feature is configured and then link:task_cli_clusters.html[back up the ONTAP Select Deploy configuration data].
