...
[TIP]
====
If the cluster creation operation is initiated but fails to complete, the ONTAP administrative password you define might not be applied. In this case, you can determine the temporary administrative password for the ONTAP Select cluster using the following CLI command: 
