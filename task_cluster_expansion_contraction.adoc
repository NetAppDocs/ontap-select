...
You can increase the size of an existing ESXi or KVM cluster in the following increments:
...
You can decrease the size of an existing ESXi or KVM cluster in the following increments:
