...
NOTE: You need to link:task_deploy_cluster.html#[deploy a new multi-node cluster] if you need a cluster size that isn't supported by cluster expansion or contraction.
