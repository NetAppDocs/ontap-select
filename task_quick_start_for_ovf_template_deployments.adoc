...
[.lead]
You can use the quick start for OVF template deployments to quickly deploy a 90-day evaluation instance of a single-node ONTAP Select cluster using an Open Virtualization Format (OVF) template on VMware ESXi.
