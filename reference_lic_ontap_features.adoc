...
* FlexCache
+
FlexCache cache volume for write-back is supported with ONTAP Select. FlexCache origin with write-back is not supported. For more information, refer to link:concept_ots_overview.html#flexcache-write-back-with-ontap-select[FlexCache write-back with ONTAP Select].
