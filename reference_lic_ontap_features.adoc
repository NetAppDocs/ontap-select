...
* ONTAP S3
* SnapLock Select Enterprise
+
SnapLock Select Enterprise is the implementation of the ONTAP SnapLock feature designed for ONTAP Select. For more information, refer to link:https://docs.netapp.com/us-en/ontap/snaplock/index.html[ONTAP SnapLock documentation^].
...
[NOTE]
====
* For ONTAP Select 9.16.1 and earlier, you can download the Enterprise version of the SnapLock Select license free of charge from the link:https://mysupport.netapp.com/site/[NetApp Support Site^] and apply it manually.
