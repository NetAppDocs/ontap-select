...
[NOTE]
If a hardware RAID controller is present, see the link:concept_stor_concepts_chars.html[Storage] section under _Deep dive_ for additional configuration requirements.
