...
---
= Learn about administering ONTAP Select
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
To identify the supported versions of the client software, review the link:https://mysupport.netapp.com/matrix/[Interoperability Matrix Tool^]. If the client software supports ONTAP 9, then the same version is also supported with ONTAP Select.
