...
= Resize ONTAP Select cluster nodes
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
. Select the *Cluster* tab at the top of the page, then select the desired cluster from the list.

. On the cluster details page, select the gear icon at the right of the page and select *Instance Resize*.

. Select the *Instance Type* and provide the ONTAP credentials, then select *Modify*.
