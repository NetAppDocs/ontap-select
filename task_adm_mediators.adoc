...
. Select the *Administration* tab at the top of the page, then select *Mediators*.

. Optionally, select *Filter* to customize your view of the two-node clusters monitored by the mediator service.
