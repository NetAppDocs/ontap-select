...
* link:sizing-capacity-tier-license.html[Learn about the considerations for sizing an ONTAP Select Capacity Tiers license]
* link:task_lic_acquire_cp.html[Learn about acquiring an ONTAP Select Capacity Pools license]
