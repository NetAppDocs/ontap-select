...
---
= License purchasing workflow for ONTAP Select
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
Learn about the considerations for sizing an ONTAP Select license:

* link:sizing-capacity-tier-license.html[Capacity Tiers license]
* link:sizing-capacity-pool-license.html[Capacity Pools license]

.Related information
link:task_adm_licenses.html[Learn about managing ONTAP Select licenses]
