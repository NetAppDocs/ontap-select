...
NOTE: The following steps are for an ONTAP select cluster on an ESXi host. You can also deploy a 90-day evaluation instance of an ONTAP select cluster on a KVM host. Contact NetApp support for more information
