...
NOTE: The following steps are for downloading an ONTAP evaluation license on an ESXi host. For information about downloading an evaluation license on a KVM host, contact your NetApp sales team.
