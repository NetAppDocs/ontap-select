...
NOTE: The following steps are for an ONTAP select cluster on an ESXi host. You can also deploy a 90-day evaluation instance on a KVM host. For more information, contact NetApp support.
