...
summary: You need to install the ONTAP Select Deploy administration utility and use the utility to deploy an ONTAP Select cluster.
---
...
[.lead]
You need to install the ONTAP Select Deploy administration utility and use the utility to deploy an ONTAP Select cluster. The Deploy installation procedure consists of multiple steps.
...
The Deploy administration utility contains a single version of ONTAP Select. If you want to deploy clusters using an earlier version of ONTAP Select, you must add the ONTAP Select image to your Deploy instance. See _Adding an ONTAP Select image to Deploy_ for more information.

.Related information

* link:ti_adm_deploy_image_add.html[Adding an ONTAP Select image to Dpeloy]
