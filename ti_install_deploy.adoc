...
[.lead]
You need to install the ONTAP Select Deploy administration utility and use the utility to createan ONTAP Select cluster. The Deploy installation procedure consists of multiple steps.
...
link:ti_adm_deploy_image_remove.html[Removing ONTAP Select images from Deploy]
