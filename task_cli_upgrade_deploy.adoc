...
[NOTE]
You can upgrade ONTAP Select Deploy 9.17.1 from ONTAP Select Deploy 9.16.1 and 9.15.1. To upgrade from older versions, review the previous release notes.
