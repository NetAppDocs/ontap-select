...
Make sure that ONTAP Select Deploy is not used to perform any other tasks during the upgrade. See the current link:reference_release_notes.html[release notes] for information and restrictions about upgrading the ONTAP Select Deploy utility.
