...
---
= Learn about using the ONTAP Select Deploy API workflows
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
* Category
The API calls are organized on the documentation page into functionally related areas or categories. To locate a specific API call, scroll to the bottom of the page and select the applicable API category.
* HTTP verb
