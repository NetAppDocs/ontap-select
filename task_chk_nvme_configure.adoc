...
* For an ESX host, ONTAP Select 9.7 or later with a supported Deploy administration utility
...
* Red Hat Enterprise Linux (RHEL) 10.1, 10.0, 9.6, 9.5, 9.4, 9.2, 9.1, 9.0, 8.8, 8.7, and 8.6
