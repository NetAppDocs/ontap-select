...
Follow the link:kvm-host-configuration-and-preparation-checklist.html[host preparation checklist], and review link:reference_chk_deploy_req_info.html[required information for Deploy utility installation], and the link:reference_chk_select_req_info.html[required information for ONTAP Select installation] for more information.
