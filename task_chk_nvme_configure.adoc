...
Follow the link:reference_chk_host_prep.html[host preparation checklist], and review the required information for link:reference_chk_deploy_req_info.html[Deploy utility installation] and link:reference_chk_select_req_info.html[ONTAP Select installation] for more information.
