...
The standard, premium, and premium XL license offerings support a wide range of hardware and software. For current information on hardware and software versions, see the link:https://mysupport.netapp.com/matrix/[Interoperability Matrix Tool^]. 
...
Minimum of two 10GbE ports for a four, six, eight, ten, or twelve-node cluster
|===
...
3+a| Red Hat Enterprise Linux 64-bit (KVM) 10.0, 9.6, 9.5, 9.4, 9.3, 9.2, 9.1, 9.0, 8.8, 8.7, and 8.6 
...
* link:concept_lic_cp_operation.html[Learn about the Capacity Pool license model]
* link:concept-capacity-tiers-license.html[Learn about the Capacity Tier license model]
