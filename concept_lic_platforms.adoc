...
3+a| Red Hat Enterprise Linux 64-bit (KVM) 10.1, 10.0, 9.6, 9.5, 9.4, 9.3, 9.2, 9.1, 9.0, 8.8, 8.7, and 8.6 

Rocky Linux (KVM) 10.0, 9.6, 9.5, 9.4, 9.3, 9.2, 9.1, 9.0, 8.9, 8.8, 8.7, and 8.6

*Note*: There are software RAID workflow limitations for KVM hypervisors on RHEL 10.1 and 10.0 hosts and Rocky Linux 10.0 hosts. For more information, see the following Knowledge Base articles:
