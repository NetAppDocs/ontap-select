...
3+a| Red Hat Enterprise Linux 64-bit (KVM) 10.1, 10.0, 9.7, 9.6, 9.5, 9.4, 9.3, 9.2, 9.1, 9.0, 8.8, 8.7, and 8.6 
...
link:concept_lic_workflow.html[Learn about purchasing an ONTAP Select license]
