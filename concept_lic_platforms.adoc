...
---
= Platform license offerings for ONTAP Select
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
.3+| Solid state drives (SSDs) in a ...
| Hardware RAID configuration
| No
| Yes
| Yes
...
The standard, premium, and premium XL license offerings support a wide range of hardware and software. For current information on hardware and software versions, refer to the link:https://mysupport.netapp.com/matrix/[Interoperability Matrix Tool^]. 
...
2+| CPU family 
a| Intel Xeon E5-26xx v3 (Haswell) or later

AMD EPYC Embedded 9004 or later and 8004
a| Intel Xeon E5-26xx v3 (Haswell) or later
...
Learn about link:concept_lic_workflow.html[purchasing an ONTAP Select license]
