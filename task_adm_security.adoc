...
== ONTAP Select Deploy CLI MFA login using YubiKey Personal Identify Verification (PIV) or Fast IDentity Online (FIDO2) authentication
...
== Configuring the public key in ONTAP Select Deploy
